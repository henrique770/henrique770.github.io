...
export const queryImage = graphql`
  query {
    ...
    project8: file(relativePath: { eq: "npm.png" }) {
      childImageSharp {
        fixed(width: 96, height: 96) {
          ...GatsbyImageSharpFixed
        }
  ...
  <Layout>
    ...
    <section className="section is-size-4-desktop is-size-5-touch">
      ...
      <p className="has-text-centered">
        ...
        <a href="https://github.com/henrique770">GitHub</a>.
      </p>
      <div className="columns is-centered">
        <div className="column is-half">
          <Card
            title="ugrowth-admin-ui"
            subtitle="Lib react, design system"
            link="https://www.npmjs.com/package/ugrowth-admin-ui"
            tags={['Storybook', 'React', 'Javascript', 'Styled components']}
            image={
              <Img
                fixed={data.project8.childImageSharp.fixed}
                alt="Clone page twitter"
              />
            }
          />{' '}
          <Card
            title="udash-ui"
            subtitle="Lib react, better version of ugrowth-admin-ui"
            link="https://www.npmjs.com/package/udash-ui"
            tags={['Storybook', 'React', 'Javascript', 'Styled components']}
            image={
              <Img
                fixed={data.project8.childImageSharp.fixed}
          ...
          <Card
            title="QuickCard"
            subtitle="Platform to study, using methods like flashcards, notes, pomodoro"
          ...
          <Card
            ...
            image={
              <Img fixed={data.project1.childImageSharp.fixed} alt="GoBarber" />
            }
          />
          {/* <Card
            title="Ugrowth"
            ...
            image={
              <Img fixed={data.project7.childImageSharp.fixed} alt="Ugrowth" />
            }
          /> */}
          <Card
            title="Rocketshoes"
          ...
          <Card
            ...
            image={
              <Img fixed={data.project6.childImageSharp.fixed} alt="DevRadar" />
            }
          />
          <Card
          ...
          <Card
            ...
            image={
              <Img
                fixed={data.project5.childImageSharp.fixed}
                alt="Clone page twitter"
              />
            }
          />{' '}
      ...
      <p className="has-text-centered">
        Check out my <Link to="/stack">Stack</Link>.
      </p>
    </section>
  </Layout>
);
